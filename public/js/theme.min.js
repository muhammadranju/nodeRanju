                        ...
                        if (o.files && o.files[0]) {
                           ...
                           (e.onload = function (e) {
                              var t = e.target.result,
                                 r = o.files[0].name;
                              if (
                                 ((a.innerHTML = r), t.startsWith("data:image"))
                              ) {
                                 var n = new Image();
                                 (n.src = t),
                                    (n.onload = function () {
               ...
               var b = function (e) {
                     ...
                     new Chartist.Pie(i[e], t, {
                        labelInterpolationFnc: function (e) {
                           return (
                              Math.round((e / t.series.reduce(a)) * 100) + "%"
                           );
                        },
                     });
                  },
...
function passwordHide() {
   document.getElementById("eye").addEventListener("click", function () {
      let passNow = document.getElementById("passField");
   ...
   document.getElementById("eye2").addEventListener("click", function () {
      let passNow = document.getElementById("passField2");
   ...
   document.getElementById("eye3").addEventListener("click", function () {
      let passNow = document.getElementById("passField3");
